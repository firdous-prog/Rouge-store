...
const products = [
  {
    id: 1,
    name: 'Classic Rouge Tee',
    category: 'T-Shirts',
    price: 34.99,
    image: 'image/product1.png',         // ← Replace with your image
    description: 'Our signature heavyweight tee. Premium 100% cotton with a relaxed fit built for everyday wear. Pre-shrunk and double-stitched for lasting quality.',
    badge: 'New',
    teespringUrl: 'https://teespring.com', // ← Replace with your Teespring URL
  },
  {
    id: 2,
    ...
    description: 'Heavyweight French terry. A relaxed oversized silhouette with a kangaroo pocket and adjustable drawstring. Drop-shouldered for a contemporary fit.',
    badge: 'New',
    teespringUrl: 'https://teespring.com',
  },
  {
    id: 3,
    ...
    description: 'Bold crimson script on a crisp white base. Ultra-soft ring-spun cotton. A statement piece that speaks before you do.',
    badge: '',
    teespringUrl: 'https://teespring.com',
  },
  {
    ...
    description: 'Clean, uncluttered, and effortlessly cool. Our midweight crewneck in classic black with a tonal Rouge emblem. A wardrobe essential.',
    badge: '',
    teespringUrl: 'https://teespring.com',
  },
  {
    id: 5,
    name: 'Rouge Bucket Hat',
    category: 'Accessories',
    price: 24.99,
    image: 'image/product5.png',
    description: 'Structured woven bucket hat with embroidered ROUGE logo. One size adjustable. UPF 30+ protection.',
    badge: 'New',
    teespringUrl: 'https://teespring.com',
  },
  {
    id: 6,
    name: 'Varsity Zip Hoodie',
    category: 'Hoodies',
    price: 74.99,
    image: 'image/product6.png',
    description: 'Full-zip heavyweight hoodie with ribbed cuffs and waistband. Two deep front pockets. The jacket you reach for every single day.',
    badge: '',
    teespringUrl: 'https://teespring.com',
  },
  {
    ...
    description: 'Large back-print graphic on a premium long sleeve base. Tagless for all-day comfort. Available in multiple colorways.',
    badge: '',
    teespringUrl: 'https://teespring.com',
  },
  {
    ...
    description: 'Heavyweight canvas tote. Generous 15L capacity with reinforced handles. The eco-friendly carry-all with a bold ROUGE stamp.',
    badge: '',
    teespringUrl: 'https://teespring.com',
  },
];
